...
risk estimates." However, sometimes the decision of exclude a confounder could be flawed, not only based on domain assumptions, but also in the logical procedure itself, as we will discuss on the example of Section \label{sec:sandhu}
