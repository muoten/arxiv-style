...
%   \And
 Enrique Otero \\
  ...
  %@eoteromuras \\
  \texttt{@eoteromuras}
  %\texttt{enrique.otero@orange.com\thanks{This paper results from personal research in my leisure time, at the moment not funded by Orange Spain or any other affiliation}} \\
  %% \AND
  %% Coauthor \\
  %% Affiliation \\
  %% Address \\
...
IARC Working Group analyzed both "20 large [...] cohort studies [...] extended from as early as the 1990s until the 2010s", and "a large number of case-control studies (approximately 150)".\cite{monograph} The monograph describes also five criteria they applied in reviewing and interpreting the available literature in order to be considered for their meta-analysis. %One of these criteria, which we will focus specifically on this paper is the "Adjustment for potential confounding factors"
